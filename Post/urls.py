...
from .views import detail_card_view, detail_comment_view, delete_comment_view, delete_card_view ,update_card_view, update_comment_view , create_card_view, create_comment_view, is_author_of_card, is_author_of_comment
